...
class PublishedGameScreen extends StatefulWidget {
  const PublishedGameScreen({super.key});

  @override
  _PublishedGameScreenState createState() => _PublishedGameScreenState();
}

class _PublishedGameScreenState extends State<PublishedGameScreen> {
  bool isCopied = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Colors.white,
        leading: IconButton(
          icon: Icon(FontAwesomeIcons.arrowLeft, color: Colors.grey[700]),
          onPressed: () {
