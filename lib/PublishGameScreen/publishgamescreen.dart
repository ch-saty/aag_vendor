...
class GamePublishedScreen extends StatefulWidget {
  const GamePublishedScreen({super.key});

  @override
  _GamePublishedScreenState createState() => _GamePublishedScreenState();
}

class _GamePublishedScreenState extends State<GamePublishedScreen>
