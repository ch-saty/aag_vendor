...
class ScheduledEventsScreen extends StatefulWidget {
  ...
  @override
  _ScheduledEventsScreenState createState() => _ScheduledEventsScreenState();
}
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 8),
            _buildEventRowItem('Game Name', event['game_name']),
            SizedBox(height: 8),
                  ...
                  switch (event['eventType']) {
                    ...
                    case 'League':
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => EditableScheduledLeagueScreen(),
                        ),
                      );
                      break;
                    case 'Game':
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => EditableScheduledGameScreen(),
                        ),
                      );
                      break;
                  }
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: 'Enter publish ID or Game Name',
          filled: true,
