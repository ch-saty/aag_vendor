...
class EditableScheduledLeagueScreen extends StatefulWidget {
  const EditableScheduledLeagueScreen({super.key});

  @override
  _EditableScheduledLeagueScreenState createState() =>
      _EditableScheduledLeagueScreenState();
}

class _EditableScheduledLeagueScreenState
    extends State<EditableScheduledLeagueScreen>
